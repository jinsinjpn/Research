...
public class PTPopulationGeneratorWithAvailability {
	...
	public static void main(String args[]) {
		 ...
		 */
		Scenario scenario = createPopulationFromCensusFile("/Users/jo/Desktop/R_Plans/data0423_strict.txt");

		/*
		 * Write population to file.
		 */
		PopulationWriter populationWriter = new PopulationWriter(scenario.getPopulation(), scenario.getNetwork());
		populationWriter.write("/Users/jo/Desktop/R_Plans/population.xml");
